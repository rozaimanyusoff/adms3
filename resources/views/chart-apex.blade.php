...
&lt;script&gt;
  var apexLineChartOptions = {
    ...
    grid: {
      borderColor: app.color.gray200,
      row: {
        colors: [app.color.gray200, 'transparent'],
        opacity: 0.5
      },
    },
    markers: {
...
&lt;script&gt;
  var apexColumnChartOptions = {
    ...
    colors: [app.color.gray900, app.color.indigo, app.color.gray300],
    series: [{
      name: 'Net Profit',
...
&lt;script&gt;
  var apexAreaChartOptions = {
    ...
    colors: [app.color.pink, app.color.gray900],
    series: [{
      name: 'series1',
...
&lt;script&gt;
  var apexBarChartOptions = {
    ...
    colors: [app.color.orange, app.color.gray900],
    stroke: {
      show: true,
      width: 1,
      colors: [app.color.white]
...
&lt;script&gt;
  var apexRadialBarChartOptions = {
    ...
    colors: [app.color.cyan, app.color.blue, app.color.indigo, app.color.gray900],
    series: [76, 67, 61, 90],
  ...
  var apexRadarChartOptions = {
    ...
    plotOptions: {
      radar: {
        size: 140,
        polygons: {
          strokeColors: app.color.gray200,
          strokeWidth: 1,
          connectorColors: app.color.gray200,
          fill: {
            colors: [hexToRgba(app.color.gray300, .25), app.color.white]
          }
        }
      }
    },
